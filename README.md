...
`npm run test` — **242 اختبارًا** تغطي:
...
**أُنجز منذ V1:** المؤسسات والهيكل والأدوار والصلاحيات ولوحة الإدارة وسجل التدقيق (المرحلة ٢) · الوارد والصادر وأرقام المراسلات والتصنيف الأمني والإحالات والمرفقات والإشعارات (المرحلة ٣) · سير العمل والمراجعة والاعتماد والتوقيع وفصل المهام والتفويض وصندوق العمل (المرحلة ٤ — راجع [`docs/workflow.md`](docs/workflow.md)) · وكيل قلم بأدوات قراءة ودفاعات حقن الأوامر (المرحلة ٥ — راجع [`docs/agent.md`](docs/agent.md)).
