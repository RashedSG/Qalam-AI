...
`npm run test` — **139 اختبارًا** تغطي:
...
بالإضافة إلى **٢١ اختبار تكامل** على PostgreSQL حقيقي (حد المعدّل، العزل بين
المستخدمين، بوابة التسجيل) — تُتخطى تلقائيًا بلا `QALAM_TEST_DATABASE_URL`.
راجع **[`docs/testing.md`](docs/testing.md)**.
