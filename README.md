...
`npm run test` — **202 اختبارًا** تغطي:
...
بالإضافة إلى **١٥٤ اختبار تكامل** على PostgreSQL حقيقي — حد المعدّل، بوابة التسجيل،
عزل المؤسسات والأدوار والنطاقات، سجل التدقيق، التصنيف الأمني، ذرّية أرقام المراسلات،
الإحالات والمرفقات، وسير العمل والاعتماد والتوقيع والتفويض. معظمها **سلبي**: «هذا
...
**أُنجز منذ V1:** المؤسسات والهيكل والأدوار والصلاحيات ولوحة الإدارة وسجل التدقيق (المرحلة ٢) · الوارد والصادر وأرقام المراسلات والتصنيف الأمني والإحالات والمرفقات والإشعارات (المرحلة ٣) · سير العمل والمراجعة والاعتماد والتوقيع وفصل المهام والتفويض وصندوق العمل (المرحلة ٤ — راجع [`docs/workflow.md`](docs/workflow.md)).
